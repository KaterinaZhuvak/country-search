...
input.addEventListener("input", ()=>{
    ...
    fetch(`https://restcountries.com/v3.1/name/${inputValue}`).then((res)=>res.json().then((post)=>{
            console.log(post);
            if (post.length > 1) for (let item of post){
                counter++;
            ...
            if (post.length > 10) {
                const myAlert = (0, _pnotifyJs.error)({
                    title: 'Error',
...
},{"@pnotify/core/dist/PNotify.js":"9RSjy","@pnotify/mobile/dist/PNotifyMobile.js":"a8oTw"}],"9RSjy":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}],"a8oTw":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
